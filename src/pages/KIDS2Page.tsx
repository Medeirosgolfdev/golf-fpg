...
export type Kids2SourceKey = "uskids" | "fpg" | "rfeg" | "fcg" | "ffgolf" | "wjgc" | "eowagr" | "doral" | "fm" | "england" | "gjgl" | "fsga" | "uajt" | "uaworlds" | "mexnacional" | "coc" | "reidtrophy" | "evianjc" | "icopa" | "interzonas" | "avtrophy" | "job" | "ebtc2" | "egtc" | "elg" | "eym" | "ejo" | "ejt" | "egr" | "optimist";
...
const SOURCE_PILLS: { key: Kids2SourceKey; label: string }[] = [
  ...
  { key: "uaworlds", label: "UA Worlds" },
  { key: "mexnacional", label: "México" },
  { key: "coc", label: "Champion of Champions" },
  { key: "reidtrophy", label: "Reid Trophy" },
  { key: "evianjc", label: "Evian JC" },
