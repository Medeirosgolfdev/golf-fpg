...
export interface GrupoJogador {
  nome: string; fed: string | null; hcp: number | string;
}

export interface GrupoEntry {
  grupo: string; clube: string; jogadores: GrupoJogador[];
  suplente?: string; capitao?: string;
}
