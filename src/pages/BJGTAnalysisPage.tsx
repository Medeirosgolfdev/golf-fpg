...
const D: RivalPlayer[]=[
  ...
  {n:"Aronas Juodis",co:"Lithuania",r:{brjgt25:{p:8,t:232,tp:19,rd:[74,77,81]},eowagr25:{p:1,t:213,tp:-3,rd:[72,71,70]},qdl25:{p:4,t:75,tp:3,rd:[75]},wjgc26_1213:{p:22,t:163,tp:17,rd:[76,87]}},up:[]},
  {n:"Marcus Karim",co:"England",r:{brjgt25:{p:2,t:218,tp:5,rd:[74,73,71]},qdl25:{p:3,t:72,tp:0,rd:[72]},wjgc26_1213:{p:8,t:150,tp:4,rd:[72,78]}},up:[]},
  {n:"Harrison Barnett",co:"England",r:{brjgt25:{p:3,t:220,tp:7,rd:[77,71,72]},qdl25:{p:6,t:78,tp:6,rd:[78]},wjgc26_1213:{p:19,t:160,tp:14,rd:[77,83]}},up:[]},
  ...
  {n:"Emile Cuanalo",co:"England",r:{eowagr25:{p:3,t:224,tp:8,rd:[70,76,78]},venice25:{p:5,t:211,tp:-5,rd:[67,71,73]},rome25:{p:2,t:139,tp:-5,rd:[70,69]},qdl25:{p:5,t:75,tp:3,rd:[75]},wjgc26_1213:{p:5,t:146,tp:0,rd:[72,74]}},up:[]},
  ...
  {n:"Maxime Vervaet",co:"Spain",r:{brjgt25:{p:10,t:239,tp:26,rd:[83,77,79]},wjgc26_1213:{p:10,t:154,tp:8,rd:[76,78]}},up:[]},
  {n:"Henry Atkinson",co:"England",r:{brjgt25:{p:11,t:239,tp:26,rd:[77,79,83]}},up:[]},
  {n:"Kirill Sedov",co:"Russian Federation",r:{brjgt25:{p:15,t:247,tp:34,rd:[84,82,81]},wjgc26_1213:{p:13,t:156,tp:10,rd:[79,77]}},up:[]},
  ...
  {n:"Daniel Avila Sanz",co:"Spain",r:{brjgt25:{p:12,t:240,tp:27,rd:[80,77,83]},wjgc26_1213:{p:24,t:164,tp:18,rd:[77,87]}},up:[]},
  ...
  {n:"Alfie Skinner",co:"Great Britain",r:{venice25:{p:13,t:217,tp:1,rd:[72,74,71]},wjgc26_1213:{p:25,t:165,tp:19,rd:[84,81]}},up:[]},
  ...
  {n:"Freddie Buck",co:"England",r:{wjgc26_1213:{p:2,t:143,tp:-3,rd:[71,72]}},up:[]},
  {n:"Harry Wang",co:"England",r:{wjgc26_1213:{p:3,t:144,tp:-2,rd:[71,73]}},up:[]},
  {n:"Leo Taylor",co:"England",r:{wjgc26_1213:{p:3,t:144,tp:-2,rd:[72,72]}},up:[]},
  {n:"Matyáš Jirásek",co:"Czech Republic",r:{wjgc26_1213:{p:7,t:149,tp:3,rd:[73,76]}},up:[]},
  {n:"Jake Notton",co:"England",r:{wjgc26_1213:{p:9,t:152,tp:6,rd:[72,80]}},up:[]},
  {n:"Harrison Jones",co:"Wales",r:{wjgc26_1213:{p:10,t:154,tp:8,rd:[74,80]}},up:[]},
  {n:"Kostadin Kaloyanov",co:"Bulgaria",r:{wjgc26_1213:{p:12,t:155,tp:9,rd:[75,80]}},up:[]},
  {n:"Seb Toft",co:"England",r:{wjgc26_1213:{p:13,t:156,tp:10,rd:[78,78]}},up:[]},
  {n:"Memphis Greenwood",co:"England",r:{wjgc26_1213:{p:15,t:157,tp:11,rd:[78,79]}},up:[]},
  {n:"Luc Taylor",co:"England",r:{wjgc26_1213:{p:16,t:158,tp:12,rd:[78,80]}},up:[]},
  {n:"Harry Mody",co:"Scotland",r:{wjgc26_1213:{p:16,t:158,tp:12,rd:[80,78]}},up:[]},
  {n:"Jack Hollingsworth",co:"England",r:{wjgc26_1213:{p:18,t:159,tp:13,rd:[77,82]}},up:[]},
  {n:"Karol Gil",co:"Poland",r:{wjgc26_1213:{p:19,t:160,tp:14,rd:[85,75]}},up:[]},
  {n:"Kris Kuusk",co:"Estonia",r:{wjgc26_1213:{p:22,t:163,tp:17,rd:[80,83]}},up:[]},
  {n:"David Filip",co:"Czech Republic",r:{wjgc26_1213:{p:26,t:169,tp:23,rd:[83,86]}},up:[]},
  {n:"Beau Wheeler",co:"England",r:{wjgc26_1213:{p:26,t:169,tp:23,rd:[86,83]}},up:[]},
  {n:"Jack Austin",co:"England",r:{wjgc26_1213:{p:26,t:169,tp:23,rd:[88,81]}},up:[]},
  {n:"George Wilson",co:"England",r:{wjgc26_1213:{p:29,t:173,tp:27,rd:[81,92]}},up:[]},
  {n:"Rafael Devic Frugier",co:"France",r:{wjgc26_1213:{p:29,t:173,tp:27,rd:[89,84]}},up:[]},
  {n:"Dylan Williams",co:"Wales",r:{wjgc26_1213:{p:32,t:181,tp:35,rd:[87,94]}},up:[]},
  {n:"Alejandro Gomez Morillo",co:"Colombia",r:{wjgc26_1213:{p:32,t:181,tp:35,rd:[90,91]}},up:[]},
  {n:"Fredrik Sonsteby",co:"Norway",r:{wjgc26_1213:{p:34,t:192,tp:46,rd:[99,93]}},up:[]},
  {n:"William Ottesen Wang",co:"Norway",r:{wjgc26_1213:{p:35,t:194,tp:48,rd:[97,97]}},up:[]},
  {n:"César Goossens",co:"Switzerland",r:{wjgc26_1213:{p:36,t:214,tp:68,rd:[111,103]}},up:[]},
  ...
  {n:"Francisco Carvalho",co:"Portugal",r:{qdl25:{p:9,t:80,tp:8,rd:[80]},wjgc26_1213:{p:29,t:173,tp:27,rd:[82,91]}},up:[]},
...
function BJGTContent({ playerFed }: { playerFed?: string }) {
          ...
          {tab === "vp2026" ? VP26_PLAYERS.filter(p => p.s).map((p, idx) => (
            ...
            <button key={p.pos} className={`course-item${selectedPlayer === p.name ? " active" : ""}`}
              ...
              <div className="course-item-meta">
                {p.rounds.join("-")} = {p.total} ({fmtSign(p.result)})
              </div>
            </button>
          ))}
        </div>
            ...
            <tbody>
              ...
              <tr className="meta-row sep-row">
                ...
                {VP26_PAR.map((_,i) => {
                  ...
                  return (
                    <React.Fragment key={i}>
                      <td className="fs-10 fw-600" style={{color: diff > 0.7 ? SC.danger : diff < 0.2 ? SC.good : "var(--text-muted)"}}>{fmtSign(diff, 1)}</td>
                      {i === 8 && <td className="col-out"></td>}
                    </React.Fragment>
                  );
                })}
              ...
              {(() => {
                ...
                return (
                  <tr style={{background:"var(--bg-success-subtle)"}}>
                    ...
                    <td className="col-out fw-700">{f9}<span className={`sc-topar ${toParClass(f9-VP26_PAR_F)}`}>{fmtSign(f9-VP26_PAR_F)}</span></td>
                    {m.s.slice(9).map((sc,i) => <td key={i+9}><span className={`sc-score ${scClass(sc, VP26_PAR[9+i])}`}>{sc}</span></td>)}
                    <td className="col-in fw-700">{b9}<span className={`sc-topar ${toParClass(b9-VP26_PAR_B)}`}>{fmtSign(b9-VP26_PAR_B)}</span></td>
                    <td className="col-total fw-700">{m.gross}<span className={`sc-topar ${toParClass(m.gross-VP26_PAR_T)}`}>{fmtSign(m.gross-VP26_PAR_T)}</span></td>
                  </tr>
                );
              })()}
            </tbody>
 ...
 <div className="fw-700 mt-4 fs-10" style={{ color: sc3m(trend, 0.15, 0.15) }}>
                      {fAvg.toFixed(2)} → {lAvg.toFixed(2)} ({fmtSign(trend, 2)})
                    </div>
                    {t5avg != null && (
 ...
 <div className="fw-600 fs-10" style={{ color: "var(--chart-4)" }}>{m.b9Avg.toFixed(0)}</div>
                  ...
                  <div className="conclusion-box bg-info bc-info">
                    <div className="caConcText c-dark-navy-11">
                      {Math.abs(avgF9Gap) < 1
                        ? <>📊 Front e Back 9 equilibrados (gap médio: {fmtSign(avgF9Gap, 1)}). Boa gestão de energia!</>
                        : avgF9Gap > 0
                      ...
                      {Math.abs(recentGap - earlyGap) > 1 && (
                        <> Gap início: {fmtSign(earlyGap, 1)} → recente: {fmtSign(recentGap, 1)}.
 ...
 <div className="caConcText fs-11" style={{ color: scDark(wVal > 2 ? "danger" : "good") }}>
                    {worse === "arranque" && avgF > 1.5
                      ...
                      : worse === "fecho" && avgL > 1.5
                        ...
                        : <>✅ Bom equilíbrio entre arranque ({fmtSign(avgF, 1)}) e fecho ({fmtSign(avgL, 1)}). Gestão de volta sólida.</>
                    }
                  </div>
                </div>
              );
 ...
 <td className="fw-600" style={{ color: SC.good }}>{m.pobPct.toFixed(0)}</td>
                    ...
                    <td style={{ color: sc2(m.first3Avg, 1.5) }}>{fmtSign(m.first3Avg, 1)}</td>
                    <td style={{ color: sc2(m.last3Avg, 1.5) }}>{fmtSign(m.last3Avg, 1)}</td>
 ...
 return <td key={h.h} className="ta-center fw-700 fs-10" style={{ color: col }}>{fmtSign(d, 1)}</td>;
                })}
