...
const EVOLUTION: EvoEntry[] = [
  {n:"Alexis Beringer",co:"Switzerland",from:"10-11",to:"10-11",y25:290,y26:246,delta:-44,pill:"STAY"},
  ...
  {n:"Kirill Sedov",co:"Russian Federation",from:"10-11",to:"12-13",y25:247,y26:234,delta:-13,pill:"UP"},
  ...
  {n:"Aineon Hiram Jabonero",co:"Philippines",from:"8-9",to:"10-11",y25:257,y26:257,delta:0,pill:"UP"},
  {n:"Hugo Luque Reina",co:"Espanha",from:"10-11",to:"12-13",y25:237,y26:239,delta:2,pill:"UP"},
  {n:"Benji Botham",co:"Northern Ireland",from:"8-9",to:"10-11",y25:240,y26:244,delta:4,pill:"UP"},
  {n:"Dmitrii Elchaninov",co:"Russian Federation",from:"10-11",to:"10-11",y25:205,y26:210,delta:5,pill:"STAY"},
  {n:"Henry Liechti",co:"Switzerland",from:"10-11",to:"10-11",y25:250,y26:255,delta:5,pill:"STAY"},
...
const C25_89: ContestData = {
  ...
  players:[
    ...
    {n:"Benji Botham",co:"Northern Ireland",fl:"🇬🇧",p:2,t:240,tp:27,rd:[{g:83,s:[5, 4, 7, 4, 4, 6, 6, 3, 4, 4, 6, 3, 5, 4, 7, 3, 4, 4]},{g:74,s:[5, 3, 3, 4, 4, 5, 4, 3, 4, 5, 4, 4, 4, 4, 6, 3, 4, 5]},{g:83,s:[6, 3, 5, 4, 3, 6, 3, 3, 8, 4, 6, 3, 5, 5, 7, 3, 4, 5]}]},
    ...
    {n:"David Dung Nguyen",co:"Vietnam",fl:"🇻🇳",p:5,t:244,tp:31,rd:[{g:81,s:[6, 3, 4, 4, 4, 6, 3, 4, 6, 4, 6, 4, 4, 5, 7, 3, 5, 3]},{g:84,s:[5, 3, 5, 3, 8, 6, 4, 4, 4, 4, 6, 3, 4, 4, 6, 4, 4, 7]},{g:79,s:[5, 4, 5, 3, 5, 4, 3, 4, 4, 6, 6, 3, 5, 4, 6, 4, 5, 3]}]},
    ...
    {n:"Aineon Hiram Jabonero",co:"Philippines",fl:"🇵🇭",p:13,t:257,tp:44,rd:[{g:83,s:[5, 3, 6, 4, 5, 5, 5, 4, 5, 4, 5, 3, 4, 4, 8, 3, 5, 5]},{g:93,s:[7, 4, 5, 4, 6, 6, 6, 4, 6, 6, 6, 5, 4, 4, 6, 3, 6, 5]},{g:81,s:[4, 4, 5, 4, 3, 6, 4, 5, 5, 6, 6, 4, 4, 4, 5, 3, 5, 4]}]},
    ...
    {n:"Hugh Dalzell",co:"Northern Ireland",fl:"🇬🇧",p:18,t:264,tp:51,rd:[{g:91,s:[7, 5, 4, 5, 6, 4, 4, 3, 4, 5, 8, 4, 7, 6, 8, 3, 4, 4]},{g:88,s:[5, 2, 8, 3, 4, 6, 5, 3, 5, 6, 6, 4, 4, 5, 8, 3, 4, 7]},{g:85,s:[7, 3, 4, 3, 3, 7, 4, 4, 4, 4, 6, 4, 6, 5, 6, 3, 7, 5]}]},
...
const C25_1011: ContestData = {
  ...
  players:[
    ...
    {n:"Henry Liechti",co:"Switzerland",fl:"🇨🇭",p:17,t:250,tp:37,rd:[{g:79,s:[6, 4, 5, 3, 3, 5, 3, 3, 4, 3, 7, 3, 6, 5, 6, 3, 5, 5]},{g:84,s:[8, 4, 5, 4, 5, 5, 4, 4, 4, 5, 5, 3, 5, 4, 6, 3, 5, 5]},{g:87,s:[5, 4, 4, 4, 5, 6, 4, 4, 4, 5, 6, 4, 7, 5, 7, 3, 5, 5]}]},
    ...
    {n:"Alexis Beringer",co:"Switzerland",fl:"🇨🇭",p:33,t:290,tp:77,rd:[{g:103,s:[7, 4, 6, 4, 5, 8, 6, 5, 4, 6, 7, 4, 7, 6, 6, 6, 5, 7]},{g:94,s:[7, 3, 5, 3, 6, 6, 5, 5, 4, 5, 7, 3, 6, 8, 6, 4, 6, 5]},{g:93,s:[8, 4, 6, 4, 6, 7, 5, 4, 3, 6, 6, 4, 6, 4, 6, 4, 5, 5]}]},
    ...
    {n:"Leon Schneitter",co:"Switzerland",fl:"🇨🇭",p:"DNS",t:0,tp:0,rd:[]},
...
const C26_1011: ContestData = {
  ...
  players:[
    ...
    {n:"William Harran",co:"Switzerland",fl:"🇨🇭",p:2,t:221,tp:5,rd:[{g:75,s:[]},{g:71,s:[5, 3, 4, 4, 3, 6, 3, 3, 4, 4, 5, 3, 4, 3, 7, 3, 3, 4]},{g:75,s:[4, 3, 4, 3, 5, 4, 4, 4, 4, 5, 6, 2, 5, 4, 5, 3, 5, 5]}]},
    ...
    {n:"Hugo Strasser",co:"Switzerland",fl:"🇨🇭",p:6,t:228,tp:12,rd:[{g:73,s:[]},{g:73,s:[6, 3, 4, 3, 4, 4, 4, 3, 6, 5, 5, 3, 5, 3, 4, 3, 4, 4]},{g:82,s:[5, 3, 3, 4, 5, 6, 3, 3, 5, 5, 6, 4, 6, 4, 7, 3, 5, 5]}]},
    ...
    {n:"Leon Schneitter",co:"Switzerland",fl:"🇨🇭",p:11,t:236,tp:20,rd:[{g:76,s:[]},{g:80,s:[8, 4, 4, 5, 4, 4, 4, 2, 4, 6, 5, 4, 6, 4, 5, 3, 4, 4]},{g:80,s:[5, 4, 5, 3, 4, 5, 5, 4, 5, 4, 5, 4, 5, 4, 8, 2, 3, 5]}]},
    ...
    {n:"Benji Botham",co:"Northern Ireland",fl:"🇬🇧",p:13,t:244,tp:28,rd:[{g:81,s:[]},{g:80,s:[6, 3, 4, 4, 4, 5, 5, 3, 6, 4, 5, 3, 5, 4, 7, 3, 5, 4]},{g:83,s:[6, 3, 4, 4, 5, 5, 4, 3, 7, 5, 6, 4, 5, 4, 6, 3, 5, 4]}]},
    ...
    {n:"Alexis Beringer",co:"Switzerland",fl:"🇨🇭",p:17,t:246,tp:30,rd:[{g:83,s:[]},{g:82,s:[7, 3, 4, 4, 4, 5, 3, 3, 5, 8, 6, 4, 4, 3, 7, 3, 5, 4]},{g:81,s:[4, 5, 5, 4, 4, 5, 7, 4, 3, 5, 5, 3, 5, 4, 5, 3, 5, 5]}]},
    ...
    {n:"Henry Liechti",co:"Switzerland",fl:"🇨🇭",p:23,t:255,tp:39,rd:[{g:79,s:[]},{g:87,s:[6, 4, 5, 3, 5, 5, 5, 3, 4, 5, 5, 4, 4, 5, 10, 4, 5, 5]},{g:89,s:[7, 6, 5, 4, 4, 6, 4, 4, 4, 7, 5, 4, 4, 5, 7, 3, 6, 4]}]},
    ...
    {n:"Aineon Hiram Jabonero",co:"Philippines",fl:"🇵🇭",p:25,t:257,tp:41,rd:[{g:88,s:[]},{g:87,s:[6, 4, 5, 4, 5, 6, 4, 2, 5, 6, 5, 4, 6, 4, 6, 4, 5, 6]},{g:82,s:[5, 6, 5, 4, 3, 6, 5, 4, 4, 4, 5, 4, 4, 4, 5, 4, 5, 5]}]},
...
const C26_1213: ContestData = {
  ...
  players:[
    ...
    {n:"César Goossens",co:"Switzerland",fl:"🇨🇭",p:36,t:320,tp:101,rd:[{g:106,s:[8, 6, 6, 6, 6, 4, 8, 5, 6, 4, 4, 9, 6, 5, 4, 8, 4, 7]},{g:103,s:[6, 7, 3, 8, 7, 7, 5, 3, 6, 6, 6, 6, 6, 3, 5, 6, 5, 8]},{g:111,s:[8, 12, 3, 10, 7, 4, 7, 5, 5, 5, 6, 6, 7, 4, 6, 6, 5, 5]}]},
