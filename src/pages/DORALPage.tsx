      ...
      cell: (row: RowWithPos) => {
        ...
        return (
          <span title={tooltip} style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
            ...
            {nEditions > 1 && <span style={{ fontSize: "var(--fs-9)", fontWeight: 700, background: "var(--bg-muted)", color: "var(--text-2)", borderRadius: "var(--radius-md)", padding: "0 5px", lineHeight: "14px" }}>{nEditions}×</span>}
          </span>
        );
      },
    },
