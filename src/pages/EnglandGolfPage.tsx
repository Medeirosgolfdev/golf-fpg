...
/* ═══════════════════════════════════════════════════════════════
   EnglandGolfPage — assente no CircuitShell partilhado.
   ...
   à cabeça). Cross-trofeu via player.divisions[].
   NOTA (2026-07-02): a versão legada pré-CircuitShell (EnglandContentLegacy /
   EnglandGolfPageLegacy, master-detail manual) foi REMOVIDA — nunca era
   alcançada em runtime (App.tsx só usa o default export).
   ═══════════════════════════════════════════════════════════════ */
