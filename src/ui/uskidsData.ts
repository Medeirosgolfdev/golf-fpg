...
export const TEES_LOOKUP: Record<number, Record<number, TeeInfo>> = {
  ...
  // Par/metros REAIS dos results 2026 (signupanytime). CR/Slope OFICIAIS do
  // PDF USKids "COURSE RATING & SLOPE 2026" (public/data/venice_open_2026_
  // course_rating_slope.pdf). Novidade 2026: TODOS os 9-12 jogam o White/Red
  // (em 2025 o B10 jogava Red/Green e o B9 Green/White); o B10 usa o tee do
  // B11 (mesmo rating 64.8/111). 9H Galzignano sem SSS → fora do lookup (SD "—").
  22243: {
    ...
    2102: { campo: "Golf Club Della Montecchia - White/Red", tee: "Boys 9", par: [5,3,4,4,4,4,3,4,5, 4,3,5,4,4,4,4,3,5], metros: [300,110,225,230,210,230,95,215,290, 210,115,294,204,235,252,258,85,289], cr: 61.0, slope: 103 },
    ...
    2118: { campo: "Golf Club Della Montecchia - White/Red", tee: "Girls 10", par: [5,3,4,4,4,4,3,4,5, 4,3,5,4,4,4,4,3,5], metros: [300,110,225,230,210,230,95,215,290, 210,115,294,204,235,252,258,85,289], cr: 65.1, slope: 105 },
    2119: { campo: "Golf Club Della Montecchia - White/Red", tee: "Girls 11", par: [5,3,4,4,4,4,3,4,5, 4,3,5,4,4,4,4,3,5], metros: [389,144,262,266,280,289,128,290,350, 255,122,330,230,265,283,290,115,325], cr: 69.8, slope: 115 },
    2120: { campo: "Golf Club Della Montecchia - White/Red", tee: "Girls 12", par: [5,3,4,4,4,4,3,4,5, 4,3,5,4,4,4,4,3,5], metros: [389,144,262,266,280,289,128,290,350, 255,122,330,230,265,283,290,115,325], cr: 69.8, slope: 115 },
  },
