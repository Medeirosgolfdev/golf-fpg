 ...
 *
 * Bucket A: top 1-1000 mids nomeados da cache, ordenados por nº torneios desc
 * (excluindo os 89 ALL CAPS + 20 top já verificados em sessões anteriores).
 * Faz VERIFY: confirma se o nome na cache bate com o que a API devolve.
 *
 * Output: verified-names-A.json + checkpoints verified-names-A-checkpoint-NNN.json
 * Checkpoint cumulativo a cada 20 mids (anti-crash).
 *
 * Como usar:
 *   1) Janela 1: https://www.signupanytime.com/plugins/links/front/linksviews.aspx?v=results&fmt=nohead&ax=1129&t=18242
 *   2) F12 -> consola -> cola este ficheiro
 *   3) Aguarda ~65 min, mantém a aba activa
 *
 * Depois: node scripts/check-names.js (já faz merge dos verified-names*.json todos)
 *
 * Estimativa: 1000 mids * ~4s = ~65 min, 50 checkpoints intermedios.
 * Range de torneios: 62-201 (forte sinal para cross-ref por strokes).
 */
